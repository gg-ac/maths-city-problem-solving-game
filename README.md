Prototype version of the rewriting rule task for George Gabriel's Leverhulme ECF 2024 project.

This repo was originally based on a Phaser template explained below:
